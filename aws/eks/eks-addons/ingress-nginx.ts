      ...
      controller: {
        service: {
          annotations: {
            ...
            "alb.ingress.kubernetes.io/certificate-arn": wildcardCertificate.arn.get(),
            ...
            "service.beta.kubernetes.io/aws-load-balancer-connection-idle-timeout":
              "3600",
            "service.beta.kubernetes.io/aws-load-balancer-ssl-cert": wildcardCertificate.arn.get(),
